...
namespace LPGSavings.Controls
{
    public partial class OutlinedMaterialEntry : Grid
    {
        ...
        public OutlinedMaterialEntry()
        {
            ...
            containerFrame.BackgroundColor = this.BackgroundColor;
            customEntry.BackgroundColor = this.BackgroundColor;
            placeholderContainer.BackgroundColor = this.BackgroundColor;
