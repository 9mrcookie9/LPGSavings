...
{
    public sealed class OpenFuelingHistoryCommand : BaseAnimationCommand
    {
        private readonly IBaseViewModel _baseViewModel;

        public OpenFuelingHistoryCommand(IBaseViewModel baseViewModel)
        {
        ...
        public override async Task ExecuteAsync(object parameter = null)
        {
            ...
            try
            {
                var secondView = new ListFuelingView();
